...
class Link_button_widget extends WP_Widget
{
    ...
    public function widget($args, $instance)
    {
        ...
        if (!empty($icon)) {
            ...
            // if (!empty($text)) {
                // $text_length = strlen(utf8_decode($text));
                // $offset_sizes = $text_length / 10;
                // while(--$offset_sizes > 0){
                    // $col_md_size+=1;
                    // $col_xs_size+=6;
                // }
                // $text = "<span class='link-btn-text'>$text</span>";
            // }
        // } else {
            // $text = "<span class='$icon' aria-hidden='true'></span>";
        // }
